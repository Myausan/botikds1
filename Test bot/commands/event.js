            ...
            collector.on('collect', async ButtonInteraction => {
                ...
                .then(async ModalInteraction => {
                    ...
                    const rowEmbed = new ActionRowBuilder()
                        .addComponents(
                            new ButtonBuilder()
                                .setCustomId('eventSendNow')
                                .setLabel('Отправить сейчас')
                                .setStyle(3),
                        )
                        .addComponents(
                            new ButtonBuilder()
                                .setCustomId('eventSendTime')
                                .setLabel('Отправить ко времени')
                                .setStyle(2),
                        )
                        .addComponents(
                            new ButtonBuilder()
                                .setCustomId('eventSendCancel')
                                .setLabel('Отменить')
                                .setStyle(4),
                        )
...
Статус: Не активен`)
                    ...
                    const collector2 = message.createMessageComponentCollector({ time: 60000 });
