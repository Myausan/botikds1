                ...
                if (buttonId == 'buttonManageRoleEditIcon') {
                    if (balance < 5000) {
                        ...
                        const errorEmbed = new EmbedBuilder()
                            ...
                            .setThumbnail(author.user.displayAvatarURL())
                            .setColor(config.colorError)
                            .setDescription(`${author}, у вас недостаточно средств, для изменения роли нужно: 5000 ${emoji}\n\n\\Ваш баланс: ${balance} ${emoji}`);
                        await ButtonInteraction.update({
                            embeds: [errorEmbed],
                            components: []
                        })
                    ...
                    const Embed = new EmbedBuilder()
                        ...
                        .setThumbnail(author.user.displayAvatarURL())
                        .setColor(config.color)
                        .setDescription(`${author}, для изменения роли нужно: 5000 ${emoji}, вы уверены, что хотите совершить данную операцию?`);
                    await ButtonInteraction.update({
                        embeds: [Embed],
                        components: [rowAgree],
                    })
