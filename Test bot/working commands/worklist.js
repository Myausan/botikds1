        ...
        try {
            ...
            collector.on('collect', async ButtonInteraction => {
                ...
                if (work == 'work2') {
                    ...
                    await connection
                        .query(`UPDATE money SET money = money+${money}, work = ${Date.now()+2*60*60*1000}, exp = exp+${money} WHERE id = ${author.id};`, {
                            type: QueryTypes.INSERT, //тип запроса: SELECT | INSERT | UPDATE | DELETE ...
                        })
                    if (ghost) {
                        return
                ...
                if (work == 'work3') {//150
                    ...
                    await connection
                        .query(`UPDATE money SET money = money+${money}, work = ${Date.now()+4*60*60*1000}, exp = exp+${money} WHERE id = ${author.id};`, {
                            type: QueryTypes.INSERT, //тип запроса: SELECT | INSERT | UPDATE | DELETE ...
                    })
                    if (ghost) {
                        return
                ...
                if (work == 'work4') { // 125
                    ...
                    await connection
                        .query(`UPDATE money SET money = money+${money}, work = ${Date.now()+6*60*60*1000}, exp = exp+${money} WHERE id = ${author.id};`, {
                            type: QueryTypes.INSERT, //тип запроса: SELECT | INSERT | UPDATE | DELETE ...
                    })
                    if (ghost) {
                        return
                ...
                if (work == 'work5') { // 100
                    ...
                    await connection
                        .query(`UPDATE money SET money = money+${money}, work = ${Date.now()+12*60*60*1000}, exp = exp+${money} WHERE id = ${author.id};`, {
                            type: QueryTypes.INSERT, //тип запроса: SELECT | INSERT | UPDATE | DELETE ...
                    })
                    if (ghost) {
                        return
