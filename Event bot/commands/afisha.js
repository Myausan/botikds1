...
module.exports = {
	data: new SlashCommandBuilder()
        ...
        .addStringOption(option => 
            option.setName('year')
            .setDescription('Год выпуска фильма/мультфильма/сериала/аниме')
            .setRequired(true))
        .addStringOption(option => 
            option.setName('genre')
            .setDescription('Жанр фильма')
            .setRequired(true))
        .addStringOption(option => 
            option.setName('time')
        ...
        try {
            ...
            .then(async ModalInteraction => {
                ...
                const embed = new EmbedBuilder()
                    ...
                    .setDescription(`<:Kino:1153008940477591564> Фильм: **${name}**
<:Moon:1153007824226492427> Год: **${year}**
<:__:1153028999665176716> Жанр: **${genre}**
<:Zvezda:1153007746619281418> Начало просмотра: **${time}** по **МСК**
