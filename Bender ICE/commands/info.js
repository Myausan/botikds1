	...
	async execute(interaction, connection, lockedCommands) {
		...
		try {
			if (command == 'deposit/withdraw') {
				...
				description = `</buyrole:1096507415601631283> - команда с помощью которой вы можете сознать кастомную роль за 5000${emoji} на первые две недели**(продление НЕ автоматически - 2500${emoji} за каждые 2 недели)**. Параметры: name(название роли), hex(цвет в формате #XXXXXX).
...
Также, вы получаете 20% с каждой продажи вашей роли на торговой площадке.`
