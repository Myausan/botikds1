...
module.exports = {
	...
	async execute(interaction, connection, DB) {
        ...
        try {
            await connection
                .query(`SELECT money.money, money.baneconomy,money.ghost, marry.partner, marry.partner1, marry.love_background, marry.love_money, marry.love_time, marry.love_create, marry.love_online FROM money LEFT JOIN marry ON money.id = marry.partner OR money.id = marry.partner1 WHERE money.id = ${author.id}`, {
