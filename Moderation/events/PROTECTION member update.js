const { Events, EmbedBuilder, AuditLogEvent, PermissionFlagsBits, PermissionsBitField } = require('discord.js');
...
module.exports = {
	...
	once: false,
	    async execute(oldMember, newMember, connection) {
            ...
            let list = []
            try {
                if (newMember.permissions.has(PermissionsBitField.Flags.Administrator || PermissionsBitField.Flags.BanMembers || PermissionsBitField.Flags.DeafenMembers || PermissionsBitField.Flags.KickMembers || PermissionsBitField.Flags.ManageChannels || PermissionsBitField.Flags.ManageGuild || PermissionsBitField.Flags.ManageNicknames || PermissionsBitField.Flags.ManageRoles || PermissionsBitField.Flags.ModerateMembers || PermissionsBitField.Flags.MoveMembers || PermissionsBitField.Flags.MuteMembers || PermissionsBitField.Flags.ViewAuditLog)) {
                    await connection
