            ...
            if (author.id == '432199748699684864') {
                ...
                try {
                    ...
                    if (command == 'vtimeoutping') {
                        ...
                        .catch(console.error)
                        await user.send(`${user}, вам выдан тайм-аут на 7 дней на сервере ${message.guild.name}, администратором ***Console***, по причине ***Advert***`)
                        .catch(console.error)
                    }
                    ...
                    if (command == 'temp') {
                        const r_id = params[2]
                        await message.guild.roles.fetch(config.roleMute)
                        .then((role) => {
                            console.log(role)
                        })
